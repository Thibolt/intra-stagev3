...
@section('content')
    ...
    <div class="jumbotron">
        ...
        <p>
            <a class="btn btn-lg btn-primary" href="{{ url('students/research-internship') }}" role="button">J'y vais ! &raquo;</a>
        </p>
    </div>
    <div class="jumbotron">
        ...
        <p>
            <a class="btn btn-lg btn-primary" href="{{ url('students/submit-internship') }}" role="button">J'y vais ! &raquo;</a>
        </p>
    </div>
    <div class="jumbotron">
        ...
        <p>
            <a class="btn btn-lg btn-primary" href="{{ url('students/evaluate-internship') }}" role="button">J'y vais ! &raquo;</a>
        </p>
    </div>
@endsection