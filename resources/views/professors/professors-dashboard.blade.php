            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        <li class="active"><a href="{{ url('#') }}"><span class="glyphicon glyphicon-tasks"></span>  Panel</a></li>
                        <li><a href="{{ url('#') }}"><span class="glyphicon glyphicon-folder-open"></span>  Editer les conventions de stage <span class="badge">42</span></a></li>
                        <li><a href="{{ url('#') }}"><span class="glyphicon glyphicon-list-alt"></span>  Récapitulatif des stages</a></li>
                        <li><a href="{{ url('#') }}"><i class="fa fa-database"></i>  Gestion de la Bases de données</a></li>
                    </ul>
                    <ul class="nav nav-sidebar">
                        <li><a href="{{ url('#') }}"><span class="glyphicon glyphicon-user"></span>  Gestion des professeurs</a></li>
                        <li><a href="{{ url('#') }}"><span class="glyphicon glyphicon-user"></span>  Gestion des étudiants</a></li>
                        <li><a href="{{ url('#') }}"><span class="glyphicon glyphicon-pencil"></span>  Modifier la convetion de stage</a></li>
                    </ul>
                </div>
                @endsection
