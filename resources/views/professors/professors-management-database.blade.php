            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="active"><a href="{{ url('professors/management-database') }}"><i class="fa fa-database"></i>  Gestion de la Bases de données</a></li>
                    </ul>
                @endsection
                ...
                @section('content')
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        <h1 class="page-header"><span class="glyphicon glyphicon-align-justify"></span> Gestion de la Bases de données</h1>

                        <div class="panel panel-default">
                            <!-- Default panel contents -->
                            <div class="panel-heading">Les Entreprises</div>
